...
const styles = StyleSheet.create({
  ...
  fieldGroup: { gap: 6 },
  inputLabel: { color: "#526159", fontSize: 11, fontWeight: "700" },
  input: {
  ...
  optionSelected: { backgroundColor: "#14251D", borderColor: "#14251D" },
  optionText: { color: "#526159", fontSize: 10, fontWeight: "700" },
  optionTextSelected: { color: "#FFFFFF" },
  emptyText: { color: "#7A847E", fontSize: 11 },
  ...
  addButtonText: { color: "#14251D", fontSize: 12, fontWeight: "800" },
  sequence: { borderTopColor: "#E1E3DD", borderTopWidth: 1, gap: 8, paddingTop: 12 },
  sequenceTitle: { color: "#14251D", fontSize: 12, fontWeight: "800" },
  eventRow: {
    alignItems: "center",
    backgroundColor: "#F7F8F4",
    borderRadius: 8,
  ...
  eventTime: { color: "#68716A", fontSize: 9, fontWeight: "700" },
  eventText: { color: "#14251D", fontSize: 10, fontWeight: "600" },
  deleteButton: { alignItems: "center", height: 24, justifyContent: "center", width: 24 },
  deleteText: { color: "#B42318", fontSize: 20, lineHeight: 20 },
});
