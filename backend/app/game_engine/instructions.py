"""Deterministic translation of supported prompt words into engine policy."""
...
def interpret_tactical_instruction(
    ...
    """Translate the supported tactical vocabulary into planner weights.

    This adapter does not invoke an LLM. Unknown words deliberately leave the
    supplied policies unchanged, keeping the engine deterministic.
    """
